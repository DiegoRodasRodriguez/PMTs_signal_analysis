function U=readrun_osci2(basedir, basename, ext, data_type)
...
elseif(data_type>2)
 ...
 M=fscanf(fid, '%g %*c',[1, 2000*4*npoints]); %inf. Only 2000*4*npoints because of memory problems!
                                   %x2000x4 adviceable
...
eval(['save ' basedir, '\', basename,'.mat ', 'U' ]);
